  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="active" href="stationhome.jsp">Home</a></li>
          <li><a href="viewstationbikes.jsp">View Bikes</a></li>
  ...
  <main id="main">
    ...
    String sname = session.getAttribute("username").toString();
       Connection co = databasecon.getconnection();
        PreparedStatement pst=co.prepareStatement("select * from bookings where sname = '"+sname+"' and status = 'waiting'");
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <div class="container">
           <center>
               <h5 style="color:BLack">View Request</h5>
           </center>
  <table class="table table-hover" style=" background-color: rgba(0,0,0,0.5);">
    ...
    <tbody style="color:white">
      ...
      <th><%=rs.getString("username")%></th>
                         ...
                         <th><%=rs.getString("tm")%></th>
                         <th><a href="accept.jsp?username=<%=rs.getString("username")%>&email=<%=rs.getString("email")%>">click</a></th>
