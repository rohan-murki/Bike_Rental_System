...
<body>
  ...
  <main id="main">
      ...
      String key = request.getParameter("sname");
      String tm = request.getParameter("tm");
       Connection co = databasecon.getconnection();
        PreparedStatement pst=co.prepareStatement("select * from allocate where sname like '%"+key+"%' ;");
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <div class="container">
           <center>
               <h5 style="color:BLack">View Stations</h5>
           </center>
  <table class="table table-hover" style=" background-color: rgba(0,0,0,0.5);">
    ...
    <tbody style="color:white">
     ...
     <th><%=rs.getString("sname")%></th>
                         <th><%=rs.getString("nob")%></th>
                         <th><a href="bookbike2.jsp?sname=<%=rs.getString("sname")%>&tm=<%=tm%>">click</a></th>
      </tr>
     <%}%>
    </tbody>
  </table>
