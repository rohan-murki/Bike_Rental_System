  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <br>
          <form action="addservicesact.jsp" method="post">
         <h6 style="color:white;font-weight: 40px; ">Add Station</h6>
 
  <label>
    <p class="label-txt">ENTER STATION NAME</p>
    <input type="text" name="stationname" required="" class="input">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
