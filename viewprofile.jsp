...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="active" href="viewprofile.jsp">View Profile</a></li>
          <li><a href="bookbike.jsp">Book Bike</a></li>
  ...
  <main id="main">
      <%
       ...
       Connection co = databasecon.getconnection();
        PreparedStatement pst=co.prepareStatement("select * from users where username='"+user+"'  ;");
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <div class="container">
           <center>
               <h5 style="color:BLack">View Profile</h5>
           </center>
  <table class="table table-hover" style=" background-color: rgba(0,0,0,0.5);">
    ...
    <tbody style="color:white">
       ...
       %>
      <tr>
      <th><img src = "Gallery/<%=rs.getString("image")%>" width="100" height="70"></th>
