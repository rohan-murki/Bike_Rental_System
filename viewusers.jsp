  ...
  <main id="main">
      <%
       ...
       Connection co = databasecon.getconnection();
        PreparedStatement pst=co.prepareStatement("select * from users  ;");
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <div class="container">
           <center>
               <h5 style="color:BLack">View Users</h5>
           </center>
  <table class="table table-hover" style=" background-color: rgba(0,0,0,0.5);">
    ...
    <tbody style="color:white">
      ...
      <th><img src = "Gallery/<%=rs.getString("image")%>" width="100" height="70"></th>
                         ...
                         <th><a href="authorize.jsp?username=<%=rs.getString("username")%>&email=<%=rs.getString("email")%>">click</a></th>
      </tr>
     <%}%>
    </tbody>
  </table>
