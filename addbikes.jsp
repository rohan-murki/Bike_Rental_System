      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="viewusers.jsp">Users</a></li>
           ...
           <li><a class="active" href="addbikes.jsp">Add Bikes</a></li>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <br>
          <form action="addbikesact.jsp" method="post">
         <h6 style="color:white;font-weight: 40px; ">Add Bikes</h6>
 
  <label>
   
    <input type="hidden" name="bname" required="" class="input">
   
  </label>
         <label>
   
    <input type="hidden" name="bnumber" required="" class="input">
  
   
  </label>
          <label>
   
    <input type="hidden" name="bcolor" required="" class="input">
    
  
  </label>
           <label>
    <p class="label-txt">ENTER NUMBER OF BIKES</p>
    <input type="text" name="nob" required="" class="input">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
