    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
       <ul>
          ...
          <li><a class="active" href="status.jsp">status</a></li>
  ...
  <main id="main">
      <%
       ...
       Connection co = databasecon.getconnection();
        PreparedStatement pst=co.prepareStatement("select * from bookings where username='"+user+"'  ;");
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <div class="container">
           <center>
               <h5 style="color:BLack">View Status</h5>
           </center>
