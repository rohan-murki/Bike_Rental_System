  ...
  <main id="main">
   ...
   Connection co = databasecon.getconnection();
    ResultSet rs=null;
      ...
      ResultSet  rs1=st.executeQuery("select * from allocate where sname = '"+user+"'");

      if(rs1.next())
      {
        
        
        rs=st.executeQuery("select * from allocate where sname = '"+user+"'");
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <div class="container">
           <center>
               <h5 style="color:BLack">View Allocated Bikes</h5>
           </center>
