        ...
        <ul>
          ...
          <li><a href="viewusers.jsp">Users</a></li>
           ...
           <li><a href="addbikes.jsp">Add Bikes</a></li>
            <li><a class="active" href="allocate.jsp">Allocate</a></li>
...
%>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <br>
          <form action="allocateact.jsp" method="post">
         <h6 style="color:white;font-weight: 40px; ">Allocate </h6>
 
  <label>
    <p class="label-txt">ENTER YOUR SERVICE</p>
     <select id="s1" name="sname"  class="input">
