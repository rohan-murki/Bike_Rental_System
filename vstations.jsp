...
<body>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="viewusers.jsp">Users</a></li>
           ...
           <li><a class="active" href="vstations.jsp">Stations</a></li>
  ...
  <main id="main">
      <%
       ...
       Connection co = databasecon.getconnection();
        PreparedStatement pst=co.prepareStatement("select * from services  ;");
  ...
  <table class="table table-hover" style=" background-color: rgba(0,0,0,0.5);width: 30%">
