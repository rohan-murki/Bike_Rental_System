    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="service.jsp">Station Service</a></li>
        </ul>
...
if (document.myform.userid.value == "") {
    ...
    if (!/^[a-zA-Z]*$/g.test(document.myform.userid.value)) {
  ...
  if (mobile.value == "" || mobile.value == null) {
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
         ...
         <h6 style="color:white;font-weight: 40px; ">Register form</h6>
  ...
  <label>
    ...
    <div class="line-box">
      <div class="line"></div>
          ...
          <label>
    <p class="label-txt">ENTER YOUR DOB</p>
    ...
    <p class="label-txt">ENTER YOUR GENDER</p>
     <select id="s1" name="gender"  class="input">
